...
function Notify-Users {
    ...
    $message = "Rippling has been removed from this device.`nPlease restart your device then follow your administrators instructions to enroll this device with your new MDM."
